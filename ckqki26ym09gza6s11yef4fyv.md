...
-  [sw-toolbox](https://github.com/GoogleChrome/sw-toolbox): полезная библиотека с учетом множества различных сценариев использования кеширования.

-  [sw-precache](https://github.com/GoogleChrome/sw-precache): инструмент для предварительного кэширования всех статических ресурсов для использования в автономном режиме.

-  [Lighthouse ](https://github.com/GoogleChrome/lighthouse): показатели аудита и производительности для прогрессивных веб-приложений.

-  [Генератор манифестов](https://brucelawson.github.io/manifest/): инструмент, который автоматически генерирует файл веб-манифеста.

-  [manifest-json](https://www.npmjs.com/package/manifest-json):  еще один инструмент (использующий командную строку) для создания файла веб-манифеста.

-  [generator-pwa](https://github.com/hemanth/generator-pwa): йоменский генератор для базового приложения PWA.

-  [UpUp](https://github.com/TalAter/UpUp): прочтите статью  [автора библиотеки](https://dev.opera.com/articles/offline-with-upup-service-workers/)  о том, как ее использовать.

-  [Web Starter Kit](https://github.com/google/web-starter-kit): шаблон для веб-разработки, включая библиотеки sw-toolbox и sw-preache.

-  [Fetch-sync](https://github.com/sdgluck/fetch-sync): Fetch Sync позволяет передавать запросы на выборку через API фоновой синхронизации, чтобы они выполнялись, если выполняются, когда UA находится в автономном режиме.

-  [Msgr](https://github.com/sdgluck/msgr): Отличная служебная программа для служебного работника / клиента.

![hashnode](https://cdn.hashnode.com/res/hashnode/image/upload/v1625119841683/KbFQcya4P.png)
...
- [PWA.Rocks](https://pwa.rocks/):  выставка лучших прогрессивных веб-приложений в мире. Он поддерживается командой Opera Developer Relations, и мы принимаем запросы на извлечение, если у вас есть великолепно адаптивный PWA. Помните, что сайты не предназначены только для мобильных устройств, поэтому лучшие PWA отлично смотрятся на компьютерах и устройствах.

-  [Google PWA Showcase](https://developers.google.com/web/showcase/): витрина Google, показывающая компании, адаптированные к PWA.

-  [Экономическое обоснование прогрессивных веб-приложений](https://cloudfour.com/thinks/the-business-case-for-progressive-web-apps/): Джейсон Григсби приводит убедительные аргументы в пользу преимуществ PWA для бизнеса.

-  [PWA африканская перспектива](https://dev.opera.com/articles/pwa-nigeria-kenya-interview/): мы интервьюируем двух великих разработчиков из Нигерии и Кении о PWA. Прочтите их мысли о том, как PWA могут помочь решить проблемы в этом регионе.

![pwa-engaging.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1625120016820/KqFb69OZZ.png)

### Книги

**Книги, которые помогут вам узнать о PWA.**

 [Прогрессивные веб-приложения](https://www.manning.com/books/progressive-web-apps): эта книга научит вас дизайну PWA и навыкам, необходимым для создания быстрых и надежных веб-сайтов, шаг за шагом рассмотрев реальные примеры.
